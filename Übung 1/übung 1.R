...
# Part (a):
mpg_data <- mpg
str(mpg_data)  #zeigt die stuktur von dem dataset
summary(mpg_data)  # zusammenfassung 

# Part (b):
sapply(mpg_data, class)  # zeigt alle datentypen
...
child_list <- list(
  child1 = list(
    name = concatenated_c[["children_names"]][1],
    age = concatenated_c[["children_ages"]][1]
  ),
  child2 = list(
    name = concatenated_c[["children_names"]][2],
    age = concatenated_c[["children_ages"]][2]
  ),
  child3 = list(
    name = concatenated_c[["children_names"]][3],
    age = concatenated_c[["children_ages"]][3]
  )
)
